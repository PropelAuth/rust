...
pub fn add_user_to_org(configuration: &configuration::Configuration, params: AddUserToOrgParams) -> Result<crate::models::SuccessfulResponse, Error<AddUserToOrgError>> {
...
pub fn allow_org_to_enable_saml(configuration: &configuration::Configuration, params: AllowOrgToEnableSamlParams) -> Result<crate::models::SuccessfulResponse, Error<AllowOrgToEnableSamlError>> {
    let local_var_configuration = configuration;
...
pub fn change_user_role_in_org(configuration: &configuration::Configuration, params: ChangeUserRoleInOrgParams) -> Result<crate::models::SuccessfulResponse, Error<ChangeUserRoleInOrgError>> {
    let local_var_configuration = configuration;
...
pub fn create_org(configuration: &configuration::Configuration, params: CreateOrgParams) -> Result<crate::models::CreateOrgResponse, Error<CreateOrgError>> {
    let local_var_configuration = configuration;
...
pub fn disallow_saml(configuration: &configuration::Configuration, params: DisallowSamlParams) -> Result<crate::models::SuccessfulResponse, Error<DisallowSamlError>> {
    let local_var_configuration = configuration;
...
pub fn fetch_org(configuration: &configuration::Configuration, params: FetchOrgParams) -> Result<crate::models::FetchOrgResponse, Error<FetchOrgError>> {
    let local_var_configuration = configuration;
...
pub fn fetch_orgs_by_query(configuration: &configuration::Configuration, params: FetchOrgsByQueryParams) -> Result<crate::models::FetchOrgsResponse, Error<FetchOrgsByQueryError>> {
    let local_var_configuration = configuration;
...
pub fn fetch_users_in_org(configuration: &configuration::Configuration, params: FetchUsersInOrgParams) -> Result<crate::models::UserPagedResponse, Error<FetchUsersInOrgError>> {
    let local_var_configuration = configuration;
...
pub fn remove_user_from_org(configuration: &configuration::Configuration, params: RemoveUserFromOrgParams) -> Result<crate::models::SuccessfulResponse, Error<RemoveUserFromOrgError>> {
    let local_var_configuration = configuration;
...
pub fn update_org(configuration: &configuration::Configuration, params: UpdateOrgParams) -> Result<crate::models::SuccessfulResponse, Error<UpdateOrgError>> {
    let local_var_configuration = configuration;
