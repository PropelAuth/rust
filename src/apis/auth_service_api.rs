...
pub fn token_verification_metadata(configuration: &configuration::Configuration) -> Result<crate::models::AuthTokenVerificationMetadata, Error<TokenVerificationMetadataError>> {
