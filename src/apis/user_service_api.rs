...
use crate::models::FetchUsersOrderBy;
...
pub async fn create_magic_link(configuration: &configuration::Configuration, params: CreateMagicLinkParams) -> Result<crate::models::MagicLink, Error<CreateMagicLinkError>> {
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/magic_link", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateMagicLinkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_user(configuration: &configuration::Configuration, params: CreateUserParams) -> Result<crate::models::CreatedUserResponse, Error<CreateUserError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_user(configuration: &configuration::Configuration, params: DeleteUserParams) -> Result<crate::models::SuccessfulResponse, Error<DeleteUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn disable_user(configuration: &configuration::Configuration, params: DisableUserParams) -> Result<crate::models::SuccessfulResponse, Error<DisableUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/disable", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn disable_user2fa(configuration: &configuration::Configuration, params: DisableUser2faParams) -> Result<crate::models::SuccessfulResponse, Error<DisableUser2faError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/disable_2fa", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DisableUser2faError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn enable_user(configuration: &configuration::Configuration, params: EnableUserParams) -> Result<crate::models::SuccessfulResponse, Error<EnableUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/enable", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn invite_user_to_org(configuration: &configuration::Configuration, params: InviteUserToOrgParams) -> Result<crate::models::SuccessfulResponse, Error<InviteUserToOrgError>> {
    ...
    let local_var_uri_str = "/api/backend/v1/invite_user";
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str);
...
pub async fn fetch_user_by_email(configuration: &configuration::Configuration, params: FetchUserByEmailParams) -> Result<crate::models::UserMetadata, Error<FetchUserByEmailError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/email", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUserByEmailError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_user_by_id(configuration: &configuration::Configuration, params: FetchUserByIdParams) -> Result<crate::models::UserMetadata, Error<FetchUserByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUserByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_user_by_username(configuration: &configuration::Configuration, params: FetchUserByUsernameParams) -> Result<crate::models::UserMetadata, Error<FetchUserByUsernameError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/username", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUserByUsernameError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_users_by_emails(configuration: &configuration::Configuration, params: FetchUsersByEmailsParams) -> Result<Vec<crate::models::UserMetadata>, Error<FetchUsersByEmailsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/emails", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUsersByEmailsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_users_by_ids(configuration: &configuration::Configuration, params: FetchUsersByIdsParams) -> Result<Vec<crate::models::UserMetadata>, Error<FetchUsersByIdsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/user_ids", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUsersByIdsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_users_by_query(configuration: &configuration::Configuration, params: FetchUsersByQueryParams) -> Result<crate::models::UserPagedResponse, Error<FetchUsersByQueryError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/query", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = email_or_username {
        local_var_req_builder = local_var_req_builder.query(&[("email_or_username", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_orgs {
        local_var_req_builder = local_var_req_builder.query(&[("include_orgs", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUsersByQueryError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_users_by_usernames(configuration: &configuration::Configuration, params: FetchUsersByUsernamesParams) -> Result<Vec<crate::models::UserMetadata>, Error<FetchUsersByUsernamesError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/usernames", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FetchUsersByUsernamesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn migrate_user(configuration: &configuration::Configuration, params: MigrateUserParams) -> Result<crate::models::CreatedUserResponse, Error<MigrateUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/migrate_user/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateUserError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_user_email(configuration: &configuration::Configuration, params: UpdateUserEmailParams) -> Result<crate::models::SuccessfulResponse, Error<UpdateUserEmailError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/email", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserEmailError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_user_metadata(configuration: &configuration::Configuration, params: UpdateUserMetadataParams) -> Result<crate::models::SuccessfulResponse, Error<UpdateUserMetadataError>> {
    let local_var_configuration = configuration;
...
pub async fn update_user_password(configuration: &configuration::Configuration, params: UpdateUserPasswordParams) -> Result<crate::models::SuccessfulResponse, Error<UpdateUserPasswordError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/password", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn clear_user_password(configuration: &configuration::Configuration, user_id: String) -> Result<crate::models::SuccessfulResponse, Error<ClearUserPasswordError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/clear_password", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ClearUserPasswordError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error)) 
    }
}

pub async fn enable_user_can_create_orgs(configuration: &configuration::Configuration, user_id: String) -> Result<crate::models::SuccessfulResponse, Error<DisableUser2faError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/can_create_orgs/enable", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn disable_user_can_create_orgs(configuration: &configuration::Configuration, user_id: String) -> Result<crate::models::SuccessfulResponse, Error<DisableUser2faError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/backend/v1/user/{user_id}/can_create_orgs/disable", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
