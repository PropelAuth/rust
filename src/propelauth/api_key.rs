use crate::apis::api_key_service_api::{
    ApiKeyError, ApiKeyQueryParams, ApiKeyValidationErrorResponse, CreateApiKeyParams, FetchApiKeyUsageError, FetchApiKeyUsageParams, ImportApiKeyParams, UpdateApiKeyParams, ValidateApiKeyParams
};
...
use crate::models::{
    CreateApiKeyResponse, FetchApiKeyResponse, FetchApiKeyUsageResponse, FetchApiKeysPagedResponse, ImportApiKeyResponse, ValidateApiKeyResponse
};
...
impl ApiKeyService<'_> {
    ...
    ) -> Result<FetchApiKeyUsageResponse, FetchApiKeyUsageError> {
        crate::apis::api_key_service_api::fetch_api_key_usage(&self.config, params)
            .await
            .map_err(|err| {
                map_autogenerated_error(
                    err,
                    FetchApiKeyUsageError::UnexpectedExceptionWithSDK,
                    |status_code, _| match status_code.as_u16() {
                        401 => FetchApiKeyUsageError::InvalidIntegrationAPIKey,
                        429 => FetchApiKeyUsageError::PropelAuthRateLimit,
                        404 => FetchApiKeyUsageError::NotFound,
                        _ => FetchApiKeyUsageError::UnknownError,
                    },
                )
            })
    }
    ...
    ) -> Result<ImportApiKeyResponse, ApiKeyError> {
        crate::apis::api_key_service_api::import_api_key(&self.config, params)
            .await
            .map_err(|err| {
                map_autogenerated_error(
                    err,
    ...
    pub async fn validate_imported_api_key(
        ...
        crate::apis::api_key_service_api::validate_imported_api_key(&self.config, params)
            .await
            .map_err(|err| {
                map_autogenerated_error(
                    err,
