...
use crate::apis::org_service_api::{
    ...
    RemoveUserFromOrgParams, UpdateOrgParams, CreateOrgSamlConnectionLinkParams,
};
use crate::models::{AddUserToOrgRequest, ChangeUserRoleInOrgRequest, CreateOrgRequest, CreateOrgResponse, FetchOrgResponse, FetchOrgsResponse, RemoveUserFromOrgRequest, UpdateOrgRequest, UserPagedResponse, CreateOrgSamlConnectionLinkResponse};
...
impl OrgService<'_> {
    ...
    pub async fn create_org_saml_connection_link(
        &self,
        params: CreateOrgSamlConnectionLinkParams,
    ) -> Result<CreateOrgSamlConnectionLinkResponse, ErrorsWithNotFound> {
        if !is_valid_id(&params.org_id) {
            return Err(ErrorsWithNotFound::NotFound);
        }

        let response = crate::apis::org_service_api::create_org_saml_connection_link(&self.config, params)
            .await
            .map_err(|err| {
                map_autogenerated_error(
                    err,
