...
use crate::apis::org_service_api::{AddUserToOrgParams, AllowOrgToEnableSamlParams, ChangeUserRoleInOrgParams, CreateOrgParams, DisallowSamlParams, FetchOrgParams, FetchOrgsByQueryParams, FetchUsersInOrgParams, RemoveUserFromOrgParams, UpdateOrgParams};
use crate::models::{AddUserToOrgRequest, ChangeUserRoleInOrgRequest, CreateOrgRequest, CreateOrgResponse, FetchOrgsResponse, RemoveUserFromOrgRequest, UpdateOrgRequest, UserPagedResponse};
...
impl OrgService<'_> {
    ...
    pub fn fetch_org(&self, org_id: String) -> Result<(), ErrorsWithNotFound> {
    ...
    pub fn add_user_to_org(
        ...
        crate::apis::org_service_api::add_user_to_org(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
    ...
    pub fn change_user_role_in_org(
        ...
        crate::apis::org_service_api::change_user_role_in_org(&self.config, params).map_err(
            |err| {
                map_autogenerated_error(
                    err,
                    OrgMissingOrRoleError::UnexpectedException,
    ...
    pub fn remove_user_from_org(
        ...
        crate::apis::org_service_api::remove_user_from_org(&self.config, params).map_err(
            |err| {
                map_autogenerated_error(
                    err,
    ...
    pub fn create_org(&self, create_org_request: CreateOrgRequest) -> Result<CreateOrgResponse, CreateOrgError> {
        let params = CreateOrgParams { create_org_request };
        let org = crate::apis::org_service_api::create_org(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ...
                |status_code, err_entity| match (status_code.as_u16(), err_entity) {
                    (
                        _,
                        Some(crate::apis::org_service_api::CreateOrgError::Status400(bad_request)),
    ...
    pub fn update_org(
        ...
        crate::apis::org_service_api::update_org(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ...
                |status_code, err_entity| match (status_code.as_u16(), err_entity) {
                    (
                        _,
                        Some(crate::apis::org_service_api::UpdateOrgError::Status400(bad_request)),
    ...
    pub fn allow_org_to_enable_saml(
        &self,
        ...
        crate::apis::org_service_api::allow_org_to_enable_saml(&self.config, params).map_err(
            |err| {
                map_autogenerated_error(
                    err,
                    ErrorsWithNotFound::UnexpectedException,
    ...
    pub fn disallow_saml(&self, params: DisallowSamlParams) -> Result<(), ErrorsWithNotFound> {
        if !is_valid_id(&params.org_id) {
            return Err(ErrorsWithNotFound::NotFound);
        }

        crate::apis::org_service_api::disallow_saml(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ErrorsWithNotFound::UnexpectedException,
                |status_code, _| match status_code.as_u16() {
