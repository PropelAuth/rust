...
use crate::apis::org_service_api::{AddUserToOrgParams, AllowOrgToEnableSamlParams, ChangeUserRoleInOrgParams, CreateOrgParams, DisallowSamlParams, FetchOrgParams, FetchOrgsByQueryParams, FetchUsersInOrgParams, InviteUserToOrgParams, RemoveUserFromOrgParams, UpdateOrgParams};
use crate::models::{AddUserToOrgRequest, ChangeUserRoleInOrgRequest, CreateOrgRequest, CreateOrgResponse, FetchOrgResponse, FetchOrgsResponse, InviteUserToOrgRequest, RemoveUserFromOrgRequest, UpdateOrgRequest, UserPagedResponse};
...
impl OrgService<'_> {
    ...
    pub async fn invite_user_to_org(
        ...
        let params = InviteUserToOrgParams {
            invite_user_to_org_request,
        };
        crate::apis::org_service_api::invite_user_to_org(&self.config, params)
            .await
            .map_err(|err| {
                println!("err: {:?}", err);
                map_autogenerated_error(
