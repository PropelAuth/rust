...
use crate::propelauth::options::BaseAuthOptions;
...
impl PropelAuth {
    pub async fn init(opts: BaseAuthOptions) -> Result<PropelAuth, InitializationError> {
        ...
        let token_verification_metadata = match opts.manual_token_verification_metadata {
            Some(metadata) => metadata,
            None => token_verification_metadata(&configuration).await.map_err(|err| {
