...
use crate::apis::user_service_api::{CreateMagicLinkParams, CreateUserParams, DeleteUserParams, DisableUser2faParams, DisableUserParams, EnableUserParams, FetchUserByEmailParams, FetchUserByIdParams, FetchUserByUsernameParams, FetchUsersByEmailsError, FetchUsersByEmailsParams, FetchUsersByIdsError, FetchUsersByIdsParams, FetchUsersByQueryError, FetchUsersByQueryParams, FetchUsersByUsernamesError, FetchUsersByUsernamesParams, MigrateUserParams, UpdateUserEmailParams, UpdateUserMetadataParams, UpdateUserPasswordParams};
use crate::models::{CreatedUserResponse, CreateMagicLinkRequest, CreateUserRequest, MagicLink, MigrateUserRequest, UserMetadata, UserPagedResponse};
...
impl UserService<'_> {
    pub fn fetch_user_by_email(
        ...
        crate::apis::user_service_api::fetch_user_by_email(&self.config, params).map_err(|err| {
    ...
    pub fn fetch_user_by_id(&self, params: FetchUserByIdParams) -> Result<UserMetadata, ErrorsWithNotFound> {
        ...
        crate::apis::user_service_api::fetch_user_by_id(&self.config, params)
            .map_err(|err| map_autogenerated_error(err, ErrorsWithNotFound::UnexpectedException, |status_code, _| {
    ...
    pub fn fetch_user_by_username(
        ...
        crate::apis::user_service_api::fetch_user_by_username(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ErrorsWithNotFound::UnexpectedException,
                |status_code, _| match status_code.as_u16() {
            ...
            map_autogenerated_error(
                ...
                |status_code, err_entity| match (status_code.as_u16(), err_entity) {
                    (_, Some(FetchUsersByUsernamesError::Status400(bad_request))) => {
                        match bad_request.query {
                            None => BatchFetchError::BadRequest("Request is invalid".to_string()),
                            Some(bad_query_reasons) => BatchFetchError::BadRequest(
                                bad_query_reasons.join(", ").to_string(),
                            ),
                        }
    ...
    pub fn fetch_users_by_query(
        &self,
        params: FetchUsersByQueryParams,
    ) -> Result<UserPagedResponse, FetchByQueryError> {
        crate::apis::user_service_api::fetch_users_by_query(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
    ...
    pub fn create_user(
        ...
        let params = CreateUserParams { create_user_request };
        crate::apis::user_service_api::create_user(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
    ...
    pub fn delete_user(&self, user_id: String) -> Result<(), ErrorsWithNotFound> {
    ...
    pub fn disable_user(&self, user_id: String) -> Result<(), ErrorsWithNotFound> {
        if !is_valid_id(&user_id) {
            return Err(ErrorsWithNotFound::NotFound);
        }

        let params = DisableUserParams { user_id };
        crate::apis::user_service_api::disable_user(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ErrorsWithNotFound::UnexpectedException,
                |status_code, _| match status_code.as_u16() {
    ...
    pub fn enable_user(&self, user_id: String) -> Result<(), ErrorsWithNotFound> {
        if !is_valid_id(&user_id) {
            return Err(ErrorsWithNotFound::NotFound);
        }

        let params = EnableUserParams { user_id };
        crate::apis::user_service_api::enable_user(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ErrorsWithNotFound::UnexpectedException,
                |status_code, _| match status_code.as_u16() {
    ...
    pub fn update_user_metadata(
        ...
        crate::apis::user_service_api::update_user_metadata(&self.config, params).map_err(
            |err| {
                map_autogenerated_error(
                    err,
    ...
    pub fn update_user_email(
        ...
        crate::apis::user_service_api::update_user_email(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
    ...
    pub fn update_user_password(
        ...
        crate::apis::user_service_api::update_user_password(&self.config, params).map_err(
            |err| {
                map_autogenerated_error(
                    err,
    ...
    pub fn disable_user_2fa(&self, user_id: String) -> Result<(), ErrorsWithNotFound> {
        if !is_valid_id(&user_id) {
            return Err(ErrorsWithNotFound::NotFound);
        }

        let params = DisableUser2faParams { user_id };
        crate::apis::user_service_api::disable_user2fa(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
                ErrorsWithNotFound::UnexpectedException,
                |status_code, _| match status_code.as_u16() {
    ...
    pub fn migrate_user(
        ...
        let params = MigrateUserParams { migrate_user_request };
        crate::apis::user_service_api::migrate_user(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
    ...
    pub fn create_magic_link(
        ...
        let params = CreateMagicLinkParams { create_magic_link_request };
        crate::apis::user_service_api::create_magic_link(&self.config, params).map_err(|err| {
            map_autogenerated_error(
                err,
