...
use crate::apis::user_service_api::{
    ...
    MigrateUserParamsV2, UpdateUserEmailParams, UpdateUserMetadataParams, UpdateUserPasswordParams,
};
use crate::models::{
    CreateMagicLinkRequest, CreateUserRequest, CreatedUserResponse, MagicLink, MigrateUserRequest,
    MigrateUserRequestV2, UserMetadata, UserPagedResponse,
};
...
impl UserService<'_> {
    ...
    pub async fn migrate_user_v2(
        &self,
        migrate_user_request: MigrateUserRequestV2,
    ) -> Result<CreatedUserResponse, MigrateUserError> {
        let params = MigrateUserParamsV2 {
            migrate_user_request,
        };
        crate::apis::user_service_api::migrate_user_v2(&self.config, params)
            .await
            .map_err(|err| {
                map_autogenerated_error(
                    err,
